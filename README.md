About django-bootstrap5-feedstock
=================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-bootstrap5-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-bootstrap5-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-bootstrap5
# for installing globally
pixi global install django-bootstrap5
```
...
It is possible to list all of the versions of `django-bootstrap5` available on your platform:
...
```
pixi search django-bootstrap5 --channel conda-forge
```
